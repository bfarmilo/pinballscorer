...
/******/ 	__webpack_require__.p = "/pinballscorer/";
/******/
...
var home_Home = function Home(props) {
	return Object(preact_min["h"])(
		...
		Object(preact_min["h"])(
			...
			Object(preact_min["h"])(
				'div',
				{ 'class': home_style_default.a.buttonArea, style: { gridTemplateColumns: props.config.scoreConfig.map(function (score) {
							return '1fr';
						}).join(' ') } },
				props.config.scoreConfig.map(function (score) {
					return Object(preact_min["h"])(
						'div',
			...
			Object(preact_min["h"])(
				'div',
				{ 'class': home_style_default.a.bonusArea, style: { gridTemplateColumns: Array.from(props.config.bonusConfig).map(function (letter) {
							return '1fr';
						}).join(' ') } },
				Array.from(props.config.bonusConfig).map(function (letter) {
					return Object(preact_min["h"])(
						'div',
...
var _ref3 = Object(preact_min["h"])(profile_Profile, { path: '/profile/:user' });
